...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/jake/www/kabooodle/framework/resources/assets/app/components/notices/Notice.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, module.exports.template)
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n    <div>\n        <template v-if=\"!fetched\">\n            <spinny class=\"text-center center-block\"></spinny>\n        </template>\n        <template v-else=\"\">\n            <template v-if=\"notices.length\">\n                <notice v-for=\"notice in notices\" :key=\"notice.id\" :id=\"notice.id\" :is_read=\"notice.is_read\" :priority=\"notice.priority\" :title=\"notice.title\" :created_at=\"notice.created_at\" :model=\"notice\" :ref_url=\"notice.reference_url\"></notice>\n            </template>\n            <template v-else=\"\">\n                <li class=\"dropdown-item\">\n                    You have no notifications.\n                </li>\n            </template>\n        </template>\n    </div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/jake/www/kabooodle/framework/resources/assets/app/components/notices/Notices.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, module.exports.template)
