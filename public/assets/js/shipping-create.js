...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/jake/www/kabooodle/framework/resources/assets/app/components/InlineFieldCustom.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, module.exports.template)
    ...
    methods: {
        ...
        claimReferenceChanged: function claimReferenceChanged(event) {
            ...
            if (elSelectedType == 'claimed_item') {
                ...
                var address = claim.shipping_address;
            ...
            if (elSelectedClaimerId) {
                var selectedClaim = _.find(this.claims, { id: parseInt(elSelectedVal) });
        ...
        fillSenderAddress: function fillSenderAddress() {
            var _this2 = this;

            $.each(this.getAddressKeys(), function (k, v) {
                if (v in _this2.sender_address) {
                    $('[name="from[' + v + ']"]').val(_this2.sender_address[v]);
                }
            });
        },
        ...
        submitParcelForm: function submitParcelForm() {
            ...
            this.$http.post(this.endpoint_submit_parcel, form_data).then(function (response) {
                ...
                if (data.hasOwnProperty('errors')) {
                    _this3.form_errors = data.errors;
                }
                notify({
                    text: data.msg
                });
            }).finally(function () {
                _this3.events.saving = false;
            });
        }
    },
    components: {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/jake/www/kabooodle/framework/resources/assets/app/components/shipping/ShippingParcelForm.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, module.exports.template)
