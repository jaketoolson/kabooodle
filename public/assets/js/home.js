...
},{"./spinner":6,"vue":3,"vue-hot-reload-api":2}],5:[function(require,module,exports){
'use strict';
...
new Vue({
    ...
    methods: {
        sendContact: function sendContact(route) {
            var _this = this;

            this.actions.saving = true;
            this.$http.post(route, this.contact_fields).then(function (response) {
                _this.createNotice(response.body.data.msg, 'success');
                _this.contact_fields.email = '';
                _this.contact_fields.name = '';
                _this.contact_fields.message = '';
            }, function (response) {
                _this.createNotice(response.body.data.msg, 'error');
            }).finally(function () {
        ...
        createNotice: function createNotice(msg, type) {
            notify({
                el: $('#form-alerts'),
                text: msg,
                type: type
    ...
    mounted: function mounted() {
        ...
        this.$nextTick(function () {
            ...
            $('#contact_form').on('hidden.bs.modal', function (e) {
                _this2.contact_fields.email = '';
                _this2.contact_fields.name = '';
                _this2.contact_fields.message = '';
                _this2.actions.saving = false;
                _this2.resetAlerts();
            });
            ...
            var collapseable_toggler = $('[data-toggle="collapseable"]');
            var collapseable_el = $('.collapseable');
            ...
            var pricing_el = $('[data-type="pricing-toggler"]');
...
},{"./Spinner.vue":4}],6:[function(require,module,exports){
'use strict';
