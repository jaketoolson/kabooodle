...
},{"../Modal.vue":6,"../Spinner.vue":7,"../current-user":9,"vue":4,"vue-hot-reload-api":2,"vue-multiselect":3,"vueify-insert-css":5}],11:[function(require,module,exports){
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/jake/www/kabooodle/framework/resources/assets/app/components/messenger/Thread.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, module.exports.template)
...
},{"../Timestamp.vue":8,"../current-user":9,"vue":4,"vue-hot-reload-api":2}],12:[function(require,module,exports){
'use strict';
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n    <div>\n        <spinny v-if=\"fetching\" :size=\"'' + 28\" class=\"text-center center-block\"></spinny>\n        <div class=\"list white\" v-if=\"threads\">\n            <thread v-for=\"thread in threads\" :key=\"thread.id\" :thread=\"thread\" :endpoint=\"thread_endpoint.replace(/::ID::/, thread.id)\"></thread>\n        </div>\n        <div v-if=\"!fetching &amp;&amp; threads.length == 0\">\n            <p class=\"text-center\">Your inbox is empty.</p>\n        </div>\n    </div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/jake/www/kabooodle/framework/resources/assets/app/components/messenger/Threads.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, module.exports.template)
...
},{"../Spinner.vue":7,"./Thread.vue":11,"vue":4,"vue-hot-reload-api":2}],13:[function(require,module,exports){
'use strict';
...
},{"./MessageUserModal.vue":10,"./Threads.vue":12}],14:[function(require,module,exports){
'use strict';
