...
},{"./spinner":56,"vue":41,"vue-hot-reload-api":39}],45:[function(require,module,exports){
'use strict';
...
},{"../Spinner.vue":44,"../inputs/StateInput.vue":51,"vue":41,"vue-hot-reload-api":39,"vueify-insert-css":42}],47:[function(require,module,exports){
'use strict';
...
},{"../Spinner.vue":44,"../users/UserSearch.vue":57,"./GuestClaim.vue":46,"vue":41,"vue-hot-reload-api":39}],48:[function(require,module,exports){
'use strict';
...
},{"../Spinner.vue":44,"../Timestamp.vue":45,"../current-user":49,"vue":41,"vue-hot-reload-api":39}],49:[function(require,module,exports){
"use strict";
...
},{"../Spinner.vue":44,"../current-user":49,"vue":41,"vue-hot-reload-api":39}],51:[function(require,module,exports){
"use strict";
...
},{"vue":41,"vue-hot-reload-api":39}],52:[function(require,module,exports){
'use strict';
...
var _ListableShareLink = require('./show/ListableShareLink.vue');

var _ListableShareLink2 = _interopRequireDefault(_ListableShareLink);
...
new Vue({
    ...
    components: {
        ...
        'listable-share': _ListableShareLink2.default,
...
},{"../Modal.vue":43,"../Spinner.vue":44,"../claims/OwnerClaim.vue":47,"../comments/Commentable.vue":48,"../users/V-Card.vue":58,"./show/ListableShareLink.vue":53,"vue-multiselect":40}],53:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    methods: {
        ...
        cancelCreateLink: function cancelCreateLink() {
            (0, _assign2.default)(this.$data, initial_state());
        },
        saveLinkName: function saveLinkName() {
            var _this = this;
            ...
            this.$http.post(this.shoppable_save_endpoint, data).then(function (response) {
                _this.is_dirty = false;
                _this.previously_saved_name = data.name;
                notify({
                    type: 'success',
                ...
                _this.actions.saving = false;
            });
        }
    },
    computed: {
        is_link_name_dirty: function is_link_name_dirty() {
        ...
        link_endpoint: function link_endpoint() {
            return this.shoppable_endpoint.replace(/::0::/, this.link_name_filter);
        },
        link_name_endpoint: function link_name_endpoint() {
        ...
        link_name_filter: {
            get: function get() {
                ...
                var temp = this.link_name ? this.link_name.replace(/[^a-z0-9-_]+/g, '') : null;
        ...
        link_name_characters_remaining: function link_name_characters_remaining() {
            var remaining = this.link_name_length_limit - this.link_name_length;
            return remaining < 20 ? remaining : false;
        },
        link_name_length: function link_name_length() {
...
},{"../../Modal.vue":43,"../../Spinner.vue":44,"babel-runtime/core-js/object/assign":1,"vue":41,"vue-hot-reload-api":39}],54:[function(require,module,exports){
'use strict';
...
},{"../Spinner.vue":44,"../current-user":49,"./MessageUserModal.vue":55,"vue":41,"vue-hot-reload-api":39}],55:[function(require,module,exports){
...
},{"../Modal.vue":43,"../Spinner.vue":44,"../current-user":49,"vue":41,"vue-hot-reload-api":39,"vue-multiselect":40,"vueify-insert-css":42}],56:[function(require,module,exports){
'use strict';
...
},{"vue":41,"vue-hot-reload-api":39,"vue-multiselect":40,"vueify-insert-css":42}],58:[function(require,module,exports){
'use strict';
...
},{"../current-user":49,"../follow/Followable.vue":50,"../messenger/MessageUser.vue":54,"vue":41,"vue-hot-reload-api":39}]},{},[52]);

//# sourceMappingURL=listables-show.js.map
