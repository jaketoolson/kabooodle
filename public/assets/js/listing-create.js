...
},{"sortablejs":42}],46:[function(require,module,exports){
...
},{"vue":44,"vue-hot-reload-api":43}],48:[function(require,module,exports){
'use strict';
...
},{"vue":44,"vue-hot-reload-api":43}],49:[function(require,module,exports){
'use strict';
...
},{"./spinner":59,"vue":44,"vue-hot-reload-api":43}],50:[function(require,module,exports){
'use strict';
...
},{"../Spinner.vue":49,"vue":44,"vue-hot-reload-api":43}],51:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    created: function created() {
        ...
        $Bus.$on('listings:saving', function () {
            $Bus.$emit('listings:options:get', _this.options);
        });
    },
    ...
    methods: {
        ...
        registerDateTimePicker: function registerDateTimePicker() {
            ...
            this.$nextTick(function () {
                ...
                var minDate = moment().add('299', 'second');
                var options = {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/jake/www/kabooodle/framework/resources/assets/app/components/inventory/Listing-Settings.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, module.exports.template)
...
},{"../Spinner.vue":49,"vue":44,"vue-hot-reload-api":43}],52:[function(require,module,exports){
...
},{"../Spinner.vue":49,"babel-runtime/core-js/object/assign":2,"vue":44,"vue-hot-reload-api":43,"vueify-insert-css":46}],53:[function(require,module,exports){
'use strict';
...
},{"../Popover.vue":48,"../Spinner.vue":49,"./ListableGrouping.vue":52,"vue":44,"vue-hot-reload-api":43}],54:[function(require,module,exports){
var __vueify_style__ = require("vueify-insert-css").insert("\n    .avatar_container .fa {\n        margin: 0;\n        padding: 0;\n        cursor: pointer;\n    }\n    .drag-area {\n        min-height: 5px;\n    }\n    #to-be-matched {\n        max-height: 200px;\n        overflow: scroll;\n    }\n")
'use strict';
...
var _ListingSettings = require('../../inventory/Listing-Settings.vue');
...
var _Listable = require('./Listable.vue');

var _Listable2 = _interopRequireDefault(_Listable);

var _InventoryToAlbumMatcher = require('./InventoryToAlbumMatcher');

var _InventoryToAlbumMatcher2 = _interopRequireDefault(_InventoryToAlbumMatcher);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var selected_sale_data = function selected_sale_data() {
    return {
...
var initial_data = function initial_data() {
    return {
...
exports.default = {
    ...
    created: function created() {
        ...
        $Bus.$on('facebook:refreshing', function (status) {
            ...
            _this.selected.sale = selected_sale_data();
        });
        ...
        $Bus.$on('listings:options:get', function (options) {
            _this.facebook_listing_options = options;
        });
        ...
        $Bus.$on('listable:selected', function (group, subgroup, listable) {
            var index = _.findIndex(_this.selected.listables, { id: listable.id });
            if (index == -1) {
                _this.selected.listables.push(listable);
            }
        ...
        $Bus.$on('listable:removed', function (groupid, subgroup, listable) {
            var index = _.findIndex(_this.selected.listables, { id: listable.id });
            if (index > -1) {
                _this.selected.listables.splice(index, 1);
            }
        ...
        $Bus.$on('listings:create:sale:selected', function () {
            _this.matching_listables.matches = [];
            _this.matching_listables.misses = [];
        });
    },
    ...
    methods: {
        toggleSalesItems: function toggleSalesItems(e) {
            this.toggle_albums = e.target.checked;
        },
        prepareSalesForPreview: function prepareSalesForPreview() {
            var _this2 = this;
            ...
            var fbsales = _.filter(this.selected.sales, { sale_type: 'facebook' });

            // Give me only the flashsales
            var flashsales = _.filter(this.selected.sales, { sale_type: 'flashsale' });
            ...
            if (fbsales.length) {
                ...
                var fbsales_by_group = _.groupBy(fbsales, 'sale_id');
                ...
                _.each(fbsales_by_group, function (sales) {
                    ...
                    for (var _i = 0; _i < sales.length; _i++) {
                        var sale = sales[_i];
                    ...
                    _this2.prepared_sales_for_preview.facebook.push(tempsale);
                });
            }
        },
        removeItemFromSelected: function removeItemFromSelected(listable) {
            var index = _.findIndex(this.selected.listables, listable);
            if (index > -1) {
                this.selected.listables.splice(index, 1);
            }
        },
        removeItemFromAlbum: function removeItemFromAlbum(listable, album, e) {
            var index = _.findIndex(album.listables, listable);
            if (index > -1) {
        ...
        removeItemFromFlashsale: function removeItemFromFlashsale(listable, sale_id, e) {
            var index = _.findIndex(this.selected.sales, { sale_id: sale_id });
            if (index > -1) {
                this.selected.sales[index].listables = _.filter(this.selected.sales[index].listables, function (local_listable) {
        ...
        addItemToAlbum: function addItemToAlbum(listable, album) {
            var index = _.findIndex(album.listables, { id: listable.id });
            if (index == -1) {
                album.listables.push(listable);
            }
        },
        addItemBackToSelected: function addItemBackToSelected(listable) {
            var index = _.findIndex(this.selected.listables, { id: listable.id });
            if (index == -1) {
         ...
         * @param e
         */
        toggleAlbumItems: function toggleAlbumItems(albumid, e) {
            var $el = $('#album_items_' + albumid);
            var $target = $(e.target);
            if ($el.is(':visible')) {
                $el.hide();
                $target.html('View');
        ...
        matchInventory: function matchInventory(e) {
            var target = e.target;
            ...
            if (target.checked) {
                ...
                // Run the tool magic tool!
                // Run the tool magic tool!
                var matched = this.buildInventoryAlbumMatchings();
        ...
        resetAllSalesForGroup: function resetAllSalesForGroup() {
            this.actions.resetting_sales = true;

            var that = this;
            var index = _.findIndex(this.postables.facebookgroups, { id: this.selected.sale.sale_id });

            if (index > -1) {
                var group = this.postables.facebookgroups[index];
        ...
        buildInventoryAlbumMatchings: function buildInventoryAlbumMatchings() {
            var _this3 = this;
            ...
            var ignored_names = ['ignore', 'do not post', 'empty'];

            // Convert to a plain javascript object, not a VUE object with reactivity :o
            var haystack = JSON.parse((0, _stringify2.default)(this.selected.sale.sale.albums));
            var needles = JSON.parse((0, _stringify2.default)(this.selected.listables));

            haystack = _.chain(haystack).map(function (album) {
            ...
            var inventoryMatcher = new _InventoryToAlbumMatcher2.default(haystack, needles);
            inventoryMatcher.performSearch().then(function () {
                _this3.matching_listables.matches = inventoryMatcher.matches();
                _this3.matching_listables.misses = inventoryMatcher.misses();

                var assigned = _this3.assignMatchingsToAlbums(inventoryMatcher.matchResults(), inventoryMatcher.misses());
        ...
        assignMatchingsToAlbums: function assignMatchingsToAlbums(matching_albums, misses) {
            var that = this;
            ...
            for (var i = 0; i < matching_albums.length; i++) {
                var matching_results = matching_albums[i];
                var listables = [];

                for (var k = 0; k < matching_results.results.length; k++) {
                    listables.push(matching_results.results[k].listable);
                }
                var groupIndex = _.findIndex(this.postables.facebookgroups, { id: this.selected.sale.sale_id });

                if (groupIndex > -1) {
                    var group = this.postables.facebookgroups[groupIndex];
            ...
            for (var _i2 = 0; _i2 < misses.length; _i2++) {
                var listable = misses[_i2];
                var index = _.findIndex(this.selected.listables, { id: listable.id });
                if (index == -1) {
                    that.addItemBackToSelected(listable);
                }
        ...
        selectFlashsale: function selectFlashsale(sale, e) {
            var index = _.findIndex(this.selected.sales, { sale_id: sale.id });
            ...
            var selected_sale = JSON.parse((0, _stringify2.default)(this.selected.sale));
            var selected_listables = JSON.parse((0, _stringify2.default)(this.selected.listables));
            selected_sale.album = {};
        ...
        selectAlbum: function selectAlbum(album, e) {
            if (album.listables.length) {
                var that = this;
                album.listables.forEach(function (listable) {
                    that.addItemBackToSelected(listable);
        ...
        selectFacebookGroup: function selectFacebookGroup(e) {
            var target = e.target;
            // determine the selected album id
            var groupId = target.options[target.selectedIndex].value;
            if (groupId && groupId > -1) {

                // Need to check if the selected group id has already been added to the saved sales.
                // If it has, retrieve it.
                var index = _.findIndex(this.selected.sales, { sale_id: groupId });
                if (index > -1) {
        ...
        getPostables: function getPostables() {
            ...
            this.$http.get(window.location.protocol + '//' + window.location.hostname + '/inventory/postables').then(function (response) {
                ...
                _this4.actions.refreshing_postables = false;
            }, function (response) {
                _this4.actions.refreshing_postables = false;
            });
        },
        selectSale: function selectSale(type) {
            var new_sale = selected_sale_data();
        ...
        gotoStepThree: function gotoStepThree() {
        ...
        resetFacebookAlbumSales: function resetFacebookAlbumSales() {
            var that = this;
        ...
        saveListing: function saveListing() {
            ...
            var flashsales = this.prepared_sales_for_preview.flashsales;
            var facebooksales = this.prepared_sales_for_preview.facebook;
            var facebooksales_total_listables = 0;
            ...
            if (facebooksales.length) {
                for (var i = 0; i < facebooksales.length; i++) {
            ...
            this.$http.post(this.save_endpoint, data).then(function (response) {
                ...
                (0, _assign2.default)(_this5.$data, initial_data());
                _this5.gotoStepOne();
            }, function (error) {
                notify({
                ...
                _this5.actions.saving = false;
                $Bus.$emit('listings:saved');
            });
        }
    },
    computed: {
        display_matches_text: function display_matches_text() {
            var matches = this.matching_listables.matches;
            var misses = this.matching_listables.misses;
        ...
        notMatchedListablesText: function notMatchedListablesText() {
            if (this.selected.listables.length) {
...
},{"../../Spinner.vue":49,"../../facebook/FacebookLogin.vue":50,"../../inventory/Listing-Settings.vue":51,"../../listables/ListableGroupings.vue":53,"./InventoryToAlbumMatcher":55,"./Listable.vue":56,"./Steps.vue":57,"babel-runtime/core-js/json/stringify":1,"babel-runtime/core-js/object/assign":2,"fuse.js":40,"vue":44,"vue-hot-reload-api":43,"vuedraggable":45,"vueify-insert-css":46}],55:[function(require,module,exports){
"use strict";
...
var InventoryToAlbumMatcher = function () {
     ...
     * @param {array} needles
     */
    function InventoryToAlbumMatcher(haystack, needles) {
        _classCallCheck(this, InventoryToAlbumMatcher);
    ...
    _createClass(InventoryToAlbumMatcher, [{
        key: "haystack",
        ...
        key: "prepareNeedle",
        value: function prepareNeedle(needle) {
        ...
        key: "normalizeScore",
        value: function normalizeScore(score) {
            return (1 - score) * 100;
        }
        ...
        key: "satisfiesMinScore",
        value: function satisfiesMinScore(score) {
        ...
        key: "satisfiesPerfectScore",
        value: function satisfiesPerfectScore(score) {
        ...
        value: function performSearch() {
            ...
            return new Promise(function (resolve) {
                var fuse = new _fuse2.default(_this.haystack(), _this.constructor.fuseOptions());
                for (var i = 0; i < _this.needles().length; i++) {
                    var needle = _this.needles()[i];
                    _this.performNeedleSearch(fuse, needle);
                }
                resolve();
            });
        }
    }, {
        key: "performNeedleSearch",
        value: function performNeedleSearch(fuse, needle) {
            // Convert VUE object to plain object so we dont have stupid nested listeners
            var temp_listable = JSON.parse(JSON.stringify(needle));

            // Build the needle we are looking for in the haystack, or rather,
            // string we are searching for in the array of possibilities.
            var name = this.prepareNeedle(needle.name);
            var name_alt = this.prepareNeedle(needle.name_alt);

            // first search param is by name_alt;
            var search_param = name_alt;

            // Search through the haystack, comparing our needle, and return array of all possible matches
            var found_results = fuse.search(search_param);
            ...
            var ideal_match = found_results[0];
            ...
            if (ideal_match && this.satisfiesPerfectScore(ideal_match.score)) {
                ...
                var style_based_ideal_match = found_results[0];
            ...
            // Result object
            var result = this.constructor.searchMatchResult();
            ...
            if (match) {
                var index = _.findIndex(this._matchresults, { key: result.album_id });
                if (index == -1) {
        ...
        key: "searchMatchResult",
        value: function searchMatchResult() {
            return {
                album_id: null,
                album: null,
                listable_id: null,
    ...
    return InventoryToAlbumMatcher;
}();

exports.default = InventoryToAlbumMatcher;

},{"fuse.js":40}],56:[function(require,module,exports){
var __vueify_style__ = require("vueify-insert-css").insert("\n    \n")
'use strict';
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n    <div class=\"inline m-r-sm\">\n        <span class=\"avatar_container _80 avatar-thumbnail\">\n            <span class=\"text-sm\">{{ listable.name }}</span>\n            <img :src=\"listable.cover_photo\">\n        </span>\n        <div class=\"block\" style=\"margin: -6px 2px 0 0\">\n            <span class=\"text-right\" @click=\"removeItem\">\n                <i class=\"fa fa-times text-danger pointer\"></i>\n            </span>\n        </div>\n    </div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/jake/www/kabooodle/framework/resources/assets/app/components/listings/create/Listable.vue"
  module.hot.dispose(function () {
    require("vueify-insert-css").cache["\n    \n"] = false
    document.head.removeChild(__vueify_style__)
  })
...
},{"vue":44,"vue-hot-reload-api":43,"vueify-insert-css":46}],57:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    created: function created() {
        ...
        $Bus.$on('listings:saved', function () {
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n    <div class=\"box-footer box-buttons dker clearfix\">\n        <template v-if=\"current_step == 1\">\n            <button :class=\"selected_listables_count == 0 ? 'disabled' : null\" :disabled=\"selected_listables_count == 0\" @click.prevent=\"$parent.gotoStepTwo\" class=\"btn white btn-sm pull-right\">Continue <i class=\"fa fa-chevron-circle-right\" aria-hidden=\"true\"></i></button>\n        </template>\n\n        <template v-if=\"current_step == 2\">\n            <button @click.prevent=\"$parent.gotoStepOne\" class=\"btn white btn-sm pull-left\"><i class=\"fa fa-chevron-circle-left\" aria-hidden=\"true\"></i> Back to inventory</button>\n            <button :class=\"selected_sales_count == 0 ? 'disabled' : null\" :disabled=\"selected_sales_count == 0\" @click.prevent=\"$parent.gotoStepThree\" class=\"btn white btn-sm pull-right\">Preview listing <i class=\"fa fa-chevron-circle-right\" aria-hidden=\"true\"></i></button>\n        </template>\n\n        <template v-if=\"current_step == 3\">\n            <button :disabled=\"disabled\" :class=\"disabled? 'disabled' : null\" @click.prevent=\"$parent.gotoStepTwo\" class=\"btn white btn-sm pull-left\"><i class=\"fa fa-chevron-circle-left\" aria-hidden=\"true\"></i> Back to sales</button>\n            <button :disabled=\"disabled\" :class=\"disabled? 'disabled' : null\" @click.prevent=\"$parent.saveListing\" class=\"btn primary btn-sm btn-save-listing pull-right\">Save listing\n                <spinny v-if=\"disabled\"></spinny>\n            </button>\n        </template>\n    </div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/jake/www/kabooodle/framework/resources/assets/app/components/listings/create/Steps.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, module.exports.template)
...
},{"../../Spinner.vue":49,"vue":44,"vue-hot-reload-api":43}],58:[function(require,module,exports){
'use strict';
...
var _CreateListing = require('./create/CreateListing.vue');
...
new Vue({
    ...
    data: {},
    components: {
        'create-listing': _CreateListing2.default,
        'facebook-login': _FacebookLogin2.default,
...
},{"../OnboardCard.vue":47,"../Spinner.vue":49,"../facebook/FacebookLogin.vue":50,"./create/CreateListing.vue":54}],59:[function(require,module,exports){
'use strict';
...
//# sourceMappingURL=listing-create.js.map
