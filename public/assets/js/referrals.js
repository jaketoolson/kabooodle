...
},{"./spinner":15,"vue":4,"vue-hot-reload-api":2}],8:[function(require,module,exports){
'use strict';
...
},{"../Spinner.vue":7,"../current-user":9,"vue":4,"vue-hot-reload-api":2}],11:[function(require,module,exports){
'use strict';
...
},{"../Spinner.vue":7,"../current-user":9,"./MessageUserModal.vue":12,"vue":4,"vue-hot-reload-api":2}],12:[function(require,module,exports){
...
},{"../Modal.vue":6,"../Spinner.vue":7,"../current-user":9,"vue":4,"vue-hot-reload-api":2,"vue-multiselect":3,"vueify-insert-css":5}],13:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    methods: {
        getReferrals: function getReferrals() {
            ...
            this.$http.get(this.referrals_endpoint).then(function (response) {
                _this.referrals = response.body.data;
            }, function (response) {}).finally(function () {
                _this.actions.fetching = false;
            });
        }
    },
    components: {
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n    <div class=\"body white p-a m-t-2\">\n        <spinny class=\"text-center center center-block m-a\" :size=\"'64'\" v-if=\"actions.fetching\"></spinny>\n        <template v-else=\"\">\n            <template v-if=\"referrals.length\">\n                <div class=\"row\">\n                    <div class=\"col-md-4\" v-for=\"referral in referrals\" :key=\"referral.id\">\n                        <v-card :outer_class=\"referral.is_qualified ? ' b-a brdr-prpl ' : null\" :user=\"referral\" :able_id=\"'referral.id'\" able_type=\"Kabooodle\\Models\\Users\" :message_endpoint=\"message_endpoint\" :follow_endpoint=\"referral.follow_endpoint\" :already_following=\"referral.already_following ? 1 : 0\"></v-card>\n                        <div class=\"text-xs clearfix p-a-xs\" :class=\"referral.is_qualified ? ' primary ' : ' b-l b-r b-b white '\">\n                            <span class=\"pull-left\" v-if=\"referral.is_qualified\">\n                                Qualified <timeago :timestamp=\"referral.qualified_on.date\"></timeago>\n                            </span>\n                            <span class=\"pull-right\">\n                                Joined <timeago :timestamp=\"referral.joined_on.date\"></timeago>\n                            </span>\n                        </div>\n                    </div>\n                </div>\n            </template>\n            <template v-else=\"\">\n                <slot></slot>\n            </template>\n        </template>\n    </div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/jake/www/kabooodle/framework/resources/assets/app/components/referrals/ReferralCards.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, module.exports.template)
...
},{"../Spinner.vue":7,"../current-user":9,"../users/V-Card.vue":16,"./../Timestamp.vue":8,"vue":4,"vue-hot-reload-api":2}],14:[function(require,module,exports){
'use strict';

var _ReferralCards = require('./ReferralCards.vue');

var _ReferralCards2 = _interopRequireDefault(_ReferralCards);
...
new Vue({
    ...
    methods: {
        triggerFbShare: function triggerFbShare(url, e) {
            FB.ui({
                method: 'share',
                display: 'popup',
                href: url
    ...
    components: {
        'referral-cards': _ReferralCards2.default
    }
}); /*
...
},{"./ReferralCards.vue":13}],15:[function(require,module,exports){
'use strict';
...
},{"../current-user":9,"../follow/Followable.vue":10,"../messenger/MessageUser.vue":11,"vue":4,"vue-hot-reload-api":2}]},{},[14]);
