...
},{"../../app/s3uploader":19,"../../vendor/fileupload/js/jquery.fileupload":23,"../../vendor/fileupload/js/jquery.fileupload-image":20,"../../vendor/fileupload/js/jquery.fileupload-process":21,"../../vendor/fileupload/js/jquery.fileupload-ui":22,"../../vendor/fileupload/js/jquery.iframe-transport":24,"../../vendor/fileupload/js/vendor/canvas-to-blob.min":25,"../../vendor/fileupload/js/vendor/jquery.ui.widget":26,"../../vendor/fileupload/js/vendor/load-image":27,"./current-user":12,"babel-runtime/core-js/json/stringify":1,"vue":8,"vue-hot-reload-api":6,"vueify-insert-css":9}],11:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    data: function data() {
        return {
            quantityBtnId: 'image_qty_btn_' + this.image.hash
        };
    },
    created: function created() {}
};
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n    <div class=\"col-sm-4 thumbnail-container m-b-2\">\n        <div class=\"box no-shadow m-b-0 p-t-1 p-b-1 r b-1 b b-a\">\n            <div class=\"item\">\n                <div class=\"item-overlay active p-l p-r \" style=\"z-index: 999;\">\n                    <a type=\"button\" style=\"\" @click=\"deleteImage(image, $event)\" :data-id=\"image.id\" class=\"pull-right text-danger\"><i class=\"fa fa-times fa-fw\"></i></a>\n                    <span class=\"pull-left label dark-white text-color\">{{ position }}</span>\n                </div>\n\n                <div class=\"thumbnail\">\n                    <img :src=\"image.location\" data-width=\"100%\" class=\"w-full\" :data-remote=\"image.location\">\n                </div>\n            </div>\n            <input type=\"hidden\" :name=\"'sizings['+sizingId +'][images]['+image.key+'][data]'\" :value=\"image.json\">\n            <div class=\"box-body m-t-0 p-b-0 p-t-0\">\n                <div class=\"image_item_component\">\n                    <label class=\"text-muted text-sm m-b-0 p-b-0\">Quantity:</label>\n                    <input type=\"text\" v-model=\"quantity\" :name=\"'sizings['+sizingId+'][images]['+image.key+'][qty]'\" :id=\"quantityBtnId\" class=\"text-center image_qty_btn\">\n                </div>\n            </div>\n        </div>\n    </div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/jake/www/kabooodle/framework/resources/assets/app/components/inventory/create/Size-Container-Image.vue"
  module.hot.dispose(function () {
    require("vueify-insert-css").cache["\n    \n"] = false
    document.head.removeChild(__vueify_style__)
  })
...
var _SizeContainerImage = require('./Size-Container-Image.vue');

var _SizeContainerImage2 = _interopRequireDefault(_SizeContainerImage);
...
exports.default = {
    ...
    mounted: function mounted() {
        ...
        $Bus.$on('image:uploaded:' + this.id, function (el, responseData) {
            responseData.quantity = 1;
            responseData.hash = responseData.id.hashCode();
            _this.images.unshift(responseData);
            ...
            _this.$nextTick(function () {
                ...
                $("input#image_qty_btn_" + responseData.hash).TouchSpin({
                    ...
                    var index = _this.images.indexOf(responseData);
                    _this.images[index].quantity = data.target.value;
                });
            });
        });
    },
...
},{"../../FileUpload.vue":10,"./Size-Container-Image.vue":13,"vue":8,"vue-hot-reload-api":6,"vue-multiselect":7,"vueify-insert-css":9}],15:[function(require,module,exports){
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n    <div>\n        <div class=\"box\" v-for=\"size_container in size_containers\" :key=\"size_container.id\">\n            <button type=\"button\" @click=\"deleteSizeContainer(size_container, $event)\" style=\"position: absolute; top: 0; right: 0; border: 0; border-radius: 0; opacity:.3\" class=\" m-l-1 pull-right btn white btn-xs text-muted \">\n                <i class=\"fa fa-times\" aria-hidden=\"true\"></i>\n            </button>\n            <size-container :s3_bucket=\"s3_bucket\" :s3_acl=\"s3_acl\" :s3_key_url=\"s3_key_url\" :sizings=\"sizings\" :id=\"size_container.id\"></size-container>\n        </div>\n    </div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/jake/www/kabooodle/framework/resources/assets/app/components/inventory/create/Size-Containers.vue"
  module.hot.dispose(function () {
    require("vueify-insert-css").cache["\n    .ps-scrollbar-x {\n        height: 11px !important;\n    }\n    .ps-scrollbar-x-rail {\n        opacity: .9 !important;\n    }\n"] = false
    document.head.removeChild(__vueify_style__)
  })
...
},{"./Size-Container.vue":14,"vue":8,"vue-hot-reload-api":6,"vueify-insert-css":9}],16:[function(require,module,exports){
'use strict';
...
},{"../../onboard":18}],17:[function(require,module,exports){
'use strict';
...
new Vue({
    ...
    methods: {
        ...
        updateDefaultPricings: function updateDefaultPricings() {
            var styleId = this.getSelectedStyleId();
            var style = _.find(this.inventory_types[0].styles, { id: styleId });
...
},{"../Modal.vue":11,"./create/Size-Containers.vue":15,"./create/onboard":16}],18:[function(require,module,exports){
'use strict';
...
},{"intro.js":4}],19:[function(require,module,exports){
'use strict';
