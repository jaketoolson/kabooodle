...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/jake/www/kabooodle/framework/resources/assets/app/components/OnboardCard.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, module.exports.template)
...
},{"./spinner":13,"vue":5,"vue-hot-reload-api":2}],10:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    computed: {
        toggledHasPending: function toggledHasPending() {
        ...
        toggledHasShipped: function toggledHasShipped() {
            if (this.toggled.length) {
    ...
    methods: {
        displayTags: function displayTags(tags) {
            var html = '';
        ...
        acceptClaim: function acceptClaim(claim) {
            ...
            this.$http.post(this.accept_endpoint, { claims: [claim.id] }).then(function (response) {
                _this._handleResponseClaims(response.body.data);
            }).finally(function () {
                _this.actions.bulk_processing = false;
            });
        },
        returnClaim: function returnClaim(claim) {
            var _this2 = this;

            confirmModal(function ($noty) {
                _this2._disableNotyButtons($noty);
                _this2.$http.post(_this2.return_endpoint, { claims: [claim.id] }).then(function (response) {
                    var index = _.findIndex(_this2.claims, { id: claim.id });
                    if (index > -1) {
                        _this2.claims.splice(index, 1);
                    }
                    _this2._triggerNotice();
                }).finally(function () {
                    _this2.actions.bulk_processing = false;
                    $noty.close();
                });
            });
        },
        bulkAccept: function bulkAccept() {
            var _this3 = this;

            this.actions.bulk_processing = true;
            this.$http.post(this.accept_endpoint, { claims: _.map(this.toggled, 'id') }).then(function (response) {
                _this3._handleResponseClaims(response.body.data);
                _this3._triggerNotice();
            }).finally(function () {
                _this3.actions.bulk_processing = false;
                _this3.toggled = [];
            });
        },
        bulkReturn: function bulkReturn() {
            var _this4 = this;

            confirmModal(function ($noty) {
                _this4._disableNotyButtons($noty);
                _this4.actions.bulk_processing = true;
                _this4.$http.post(_this4.return_endpoint, { claims: _.map(_this4.toggled, 'id') }).then(function (response) {
                    _.each(_this4.toggled, function (claim) {
                        var index = _.findIndex(_this4.claims, { id: claim.id });
                        if (index > -1) {
                            _this4.claims.splice(index, 1);
                        }
                    });
                    _this4._triggerNotice();
                }).finally(function () {
                    _this4.actions.bulk_processing = false;
                    _this4.toggled = [];
                    $noty.close();
                });
            });
        },
        toggleTagging: function toggleTagging() {
            this.actions.tagging = !!this.actions.tagging == false;
        },
        bulkShippingLabel: function bulkShippingLabel() {},
        bulkTag: function bulkTag() {
            ...
            this.$http.post(this.label_endpoint, {
                ...
                _this5._handleResponseClaims(response.body.data);
                _this5._triggerNotice();
            }).finally(function () {
                _this5.actions.bulk_processing = false;
                _this5.actions.tagging = false;
                _this5.toggled = [];
                _this5.tag = [];
            });
        },
        _disableNotyButtons: function _disableNotyButtons($noty) {
            $noty.$buttons.find('.noty-btn-primary').html(spinny()).end().find('.noty-btn').addClass('disabled').prop('disabled', true);
        },
        _triggerNotice: function _triggerNotice(type, msg) {
            notify({
                type: type ? type : 'success',
                text: msg ? msg : 'Success'
            });
        },
        _handleResponseClaims: function _handleResponseClaims(claims) {
            var _this6 = this;

            _.each(claims, function (claim) {
                var index = _.findIndex(_this6.claims, { id: claim.id });
                if (index > -1) {
                    _this6.claims[index] = claim;
                }
            });
        },
        toggleClaim: function toggleClaim(claim, event) {
            var index = _.findIndex(this.toggled, { id: claim.id });
            if (index > -1) {
        ...
        fetchInfinite: function fetchInfinite() {
            ...
            if (url) {
                ...
                this.$nextTick(function () {
                    _this7.$refs.listingFinite.$emit('$InfiniteLoading:complete');
                });
            }
        },
        ...
        fetchItems: function fetchItems(url, data) {
            ...
            this.$http.get(url, { params: data }).then(function (response) {
                _this8.handleResponse(response);
            });
        },
        ...
        handleResponse: function handleResponse(response) {
            ...
            this.$nextTick(function () {
                if (_this9.claims.length >= _this9.pagination.total || _this9.pagination.total == 0) {
                    _this9.$refs.listingFinite.$emit('$InfiniteLoading:complete');
                } else {
                    _this9.$refs.listingFinite.$emit('$InfiniteLoading:loaded');
                }
            });
...
},{"../Modal.vue":7,"../OnboardCard.vue":8,"../Spinner.vue":9,"./../Timestamp.vue":10,"vue":5,"vue-hot-reload-api":2,"vue-infinite-loading":3,"vue-multiselect":4,"vueify-insert-css":6}],12:[function(require,module,exports){
'use strict';
...
},{"./Claims-index.vue":11}],13:[function(require,module,exports){
'use strict';
