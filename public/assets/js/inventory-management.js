...
},{"vue":40,"vue-hot-reload-api":39}],43:[function(require,module,exports){
'use strict';
...
},{"vue":40,"vue-hot-reload-api":39}],44:[function(require,module,exports){
'use strict';
...
},{"./spinner":49,"vue":40,"vue-hot-reload-api":39}],45:[function(require,module,exports){
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/jake/www/kabooodle/framework/resources/assets/app/components/facebook/FacebookLogin.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, module.exports.template)
...
},{"../Spinner.vue":44,"vue":40,"vue-hot-reload-api":39}],46:[function(require,module,exports){
'use strict';
...
var _ListableGroupings = require('../listables/ListableGroupings.vue');

var _ListableGroupings2 = _interopRequireDefault(_ListableGroupings);
...
new Vue({
    ...
    created: function created() {
        ...
        $Bus.$on('listables:fetched', function (listables) {
            _this.listables = listables;
            _this.actions.refreshing_data = false;
        });
        $Bus.$on('listings:selected:listable:added', function (group, subgroup, listable) {
            var index = _.findIndex(_this.selected.listables, { id: listable.id });
            if (index == -1) {
                _this.selected.listables.push(listable);
            }
        });
        $Bus.$on('listings:selected:listable:removed', function (groupid, subgroup, listable) {
            var index = _.findIndex(_this.selected.listables, { id: listable.id });
            if (index > -1) {
                _this.selected.listables.splice(index, 1);
            }
    ...
    methods: {
        resetSelectedListables: function resetSelectedListables() {
            this.selected.listables = [];
            $Bus.$emit('listings:selected:listables:reset');
        },
        selectAllListables: function selectAllListables() {
            $Bus.$emit('listings:listables:select:all');
        }
    },
    components: {
        'listable-groupings': _ListableGroupings2.default,
...
},{"../OnboardCard.vue":42,"../Spinner.vue":44,"../facebook/FacebookLogin.vue":45,"../listables/ListableGroupings.vue":48}],47:[function(require,module,exports){
...
},{"../Spinner.vue":44,"babel-runtime/core-js/object/assign":1,"vue":40,"vue-hot-reload-api":39,"vueify-insert-css":41}],48:[function(require,module,exports){
'use strict';
...
var _ListableGrouping = require('./ListableGrouping.vue');
...
exports.default = {
    ...
    methods: {
        toggleHideUnavailable: function toggleHideUnavailable() {
            this.hideUnavailable = !this.hideUnavailable;
        },
        toggleDisableUnavailable: function toggleDisableUnavailable() {
        ...
        getListables: function getListables(endpoint) {
            var _this2 = this;

            this.actions.fetching_listables = true;
            this.$http.get(endpoint ? endpoint : this.listablegroupings_endpoint).then(function (response) {
                ...
                if (response.body.data.data.length > 0) {
                    _.each(response.body.data.data, function (groupings) {
                        _this2.listable_groupings.push(groupings);
                        _.each(groupings.subgroupings, function (group) {
                            _.each(group.listables, function (listable) {
                                _this2.listables.push(listable);
                            });
                        });
                    });
                }

                _this2.listable_groupings = _.sortBy(_this2.listable_groupings, ['name']);
                _this2.actions.fetching_listables = false;
                if (pagination.next_page_url) {
                    _this2.getListables(pagination.next_page_url);
                } else {
                    $Bus.$emit('listables:fetched', _this2.listable_groupings);
                }
            });
        }
    },
    components: {
        'spinny': _Spinner2.default,
        'listable-grouping': _ListableGrouping2.default,
        'popout-overlay': _Popover2.default
    }
};
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n    <div>\n            <div v-if=\"show_select_buttons\" class=\"text-center m-b-1 center-block\">\n                <button style=\"width: 140px\" :disabled=\"actions.fetching_listables ? true : false\" :class=\"actions.fetching_listables ? 'disabled' :  null\" @click.prevent=\"selectAllListables\" class=\"btn white btn-md\">\n                    Select all\n                    <span class=\"text-sm text-muted block\">({{this.listables.length}})</span>\n                </button>\n                <button style=\"width: 140px\" :disabled=\"actions.fetching_listables ? true : false\" :class=\"actions.fetching_listables ? 'disabled' :  null\" @click.prevent=\"resetSelectedListables\" class=\"btn white btn-md\">\n                    Unselect all\n                    <span class=\"text-sm text-muted block\">({{this.listables.length}})</span>\n                </button>\n\n                        <div class=\"text-center center-block center m-t-sm\">\n                                <label class=\"checkbox\">\n                                    <input @change=\"toggleDisableUnavailable\" type=\"checkbox\" value=\"1\" class=\"has-value\" :checked=\"disableUnavailable\"><span class=\"text-sm\">Disable unavailable items</span>\n                                </label>\n                                <label class=\"checkbox\">\n                                    <input @change=\"toggleHideUnavailable\" :checked=\"hideUnavailable\" type=\"checkbox\" value=\"1\" class=\"has-value\">\n                                    <span class=\"text-sm\">Hide unavailable items</span>\n                                </label>\n                        </div>\n            </div>\n            <listable-grouping v-for=\"group in listable_groupings\" key=\"group.id\" group_type=\"inventory\" :group=\"group\" :display_footer_buttons=\"display_footer_buttons\" :display_toggle_all_buttons=\"display_toggle_all_buttons\" :disable-unavailable=\"disableUnavailable\" :hide-unavailable=\"hideUnavailable\" :inventory-index-route=\"inventoryIndexRoute\"></listable-grouping>\n        <div v-if=\"actions.fetching_listables\" class=\"text-center center-block\">\n            <spinny :size=\"'20'\"></spinny>\n        </div>\n        <popout-overlay></popout-overlay>\n    </div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/jake/www/kabooodle/framework/resources/assets/app/components/listables/ListableGroupings.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, module.exports.template)
...
},{"../Popover.vue":43,"../Spinner.vue":44,"./ListableGrouping.vue":47,"vue":40,"vue-hot-reload-api":39}],49:[function(require,module,exports){
'use strict';
