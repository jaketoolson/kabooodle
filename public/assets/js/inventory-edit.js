...
exports.default = {
    ...
    methods: {
        ...
        archiveItem: function archiveItem(item, event) {
            event.preventDefault();
            var scope = this;
            var $form = $(event.target).closest('form');
            var action = this.archive_endpoint.replace('::ID::', item.id);
            this.archiving = true;
        ...
        activateItem: function activateItem(item, event) {
            event.preventDefault();
            var scope = this;
            var $form = $(event.target).closest('form');
            var action = this.archive_endpoint.replace('::ID::', item.id);
...
},{"../../FileUpload.vue":9,"../../Spinner.vue":10,"../../Timestamp.vue":11,"vue":7,"vue-hot-reload-api":5,"vue-multiselect":6,"vueify-insert-css":8}],14:[function(require,module,exports){
'use strict';
