...
new Vue({
    ...
    methods: {
        selectAll: function selectAll(e) {
            var $itemEls = $('input.listing-item-checkbox');
         ...
         * @param e
         */
        deleteListingItem: function deleteListingItem(endpoint, id, type, e) {
         ...
         * @param {object} e
         */
        deleteFacebookListingItem: function deleteFacebookListingItem(endpoint, id, type, e) {
            var successCb = function successCb($noty, response) {
...
//# sourceMappingURL=listing-detailed.js.map
