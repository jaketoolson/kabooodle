...
},{"./spinner":13,"vue":5,"vue-hot-reload-api":2}],8:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    computed: {
        ...
        i_am_admin: function i_am_admin() {
            if ((0, _currentUser2.default)()) {
                if ((0, _currentUser2.default)().id == this.flashsale.owner.id) {
                    return true;
                }
                _.find(this.flashsale.admins, function (admin) {
                    if (admin) {
                        return parseInt(admin.id) == parseInt((0, _currentUser2.default)().id);
                    }
                    return false;
                });
            }
...
},{"../Timestamp.vue":8,"../current-user":9,"vue":5,"vue-hot-reload-api":2}],11:[function(require,module,exports){
'use strict';
...
var _FlashsaleCard = require('./Flashsale-card.vue');

var _FlashsaleCard2 = _interopRequireDefault(_FlashsaleCard);
...
exports.default = {
    ...
    created: function created() {
        ...
        $Bus.$on('flashsales:filter', function (salename, sellers) {
            _this.filtering = true;
            _this.flashsales = [];
            _this.fetchItems(_this.fetch_endpoint, { name: salename, sellers: sellers });
        });
    },
    ...
    methods: {
        ...
        handleResponse: function handleResponse(response) {
            ...
            this.$nextTick(function () {
                if (_this4.flashsales.length >= _this4.pagination.total) {
    ...
    components: {
        ...
        'flashsale-card': _FlashsaleCard2.default,
        InfiniteLoading: _vueInfiniteLoading2.default
    }
};
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n    <div>\n            <div v-for=\"flashsale in flashsales\" :key=\"flashsale.id\" class=\"col-md-3\">\n                <flashsale-card :flashsale=\"flashsale\" :show_endpoint=\"show_endpoint.replace(/::0::/, flashsale.uuid)\"></flashsale-card>\n            </div>\n            <infinite-loading :on-infinite=\"fetchInfinite\" ref=\"listingFinite\">\n                <span slot=\"no-more\"><span v-if=\"!fetching\">End results.</span></span>\n                <span slot=\"no-results\"><span v-if=\"!fetching\">End results.</span></span>\n                <span slot=\"spinner\"><spinny class=\"text-center center-block\" :size=\"'' + 38\"></spinny></span>\n            </infinite-loading>\n    </div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/jake/www/kabooodle/framework/resources/assets/app/components/flashsales/Flashsales.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, module.exports.template)
...
},{"../Spinner.vue":7,"./Flashsale-card.vue":10,"vue":5,"vue-hot-reload-api":2,"vue-infinite-loading":3}],12:[function(require,module,exports){
'use strict';

var _Flashsales = require('./Flashsales.vue');

var _Flashsales2 = _interopRequireDefault(_Flashsales);
...
new Vue({
    ...
    created: function created() {
        ...
        $Bus.$on('fetch:completed', function (flashsales) {
            _this.flashsales = flashsales;
        });
    },

    methods: {
        searchSellers: function searchSellers(qry) {},
    ...
    components: {
        'spinny': _Spinner2.default,
        'flashsales-cards': _Flashsales2.default,
        'multiselect': _vueMultiselect2.default,
        'onboard-card': _OnboardCard2.default
    }
});

},{"../OnboardCard.vue":6,"../Spinner.vue":7,"./Flashsales.vue":11,"vue-multiselect":4}],13:[function(require,module,exports){
'use strict';
...
//# sourceMappingURL=flashsales-index.js.map
