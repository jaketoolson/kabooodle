...
if (module.hot) {(function () {  module.hot.accept()
  ...
  var id = "/Users/jake/www/kabooodle/framework/resources/assets/app/components/Popover.vue"
  if (!module.hot.data) {
...
},{"./spinner":9,"vue":3,"vue-hot-reload-api":2}],7:[function(require,module,exports){
"use strict";
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/jake/www/kabooodle/framework/resources/assets/app/components/listables/DetailedTotals.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, module.exports.template)
...
var _DetailedTotals = require('./DetailedTotals.vue');

var _DetailedTotals2 = _interopRequireDefault(_DetailedTotals);

var _Spinner = require('../Spinner.vue');

var _Spinner2 = _interopRequireDefault(_Spinner);

var _Vuetable = require('../vuetable/Vuetable.vue');

var _Vuetable2 = _interopRequireDefault(_Vuetable);

var _VuetablePagination = require('../vuetable/VuetablePagination.vue');

var _VuetablePagination2 = _interopRequireDefault(_VuetablePagination);

var _VuetablePaginationInfo = require('../vuetable/VuetablePaginationInfo.vue');
...
new Vue({
    ...
    methods: {
        archiveItem: function archiveItem(id, endpoint, e) {
            endpoint = endpoint.replace('K', id);
            this.$emit('archiving-item', id);
            var parentDropdown = $(e.target).closest('.dropdown').find('.dropdown-toggle');
            parentDropdown.prop('disabled', true).addClass('disabled');
            this.$http.put(endpoint).then(function (response) {
        ...
        viewItemButtonClicked: function viewItemButtonClicked(slug, route, event) {
            window.location.href = route.replace('K', slug);
        },
        editItemButtonClicked: function editItemButtonClicked(slug, route, ajax, event) {
        ...
        claimButtonClicked: function claimButtonClicked(slug, route, event) {
            window.location.href = route.replace('K', slug);
        },
        nameWithImg: function nameWithImg(val) {
            var fields = val.split('::');

            return '<div class="avatar-thumbnail-container"> ' + '<div class="avatar-thumbnail _32 m-r-xs"> ' + '<img data-toggle="lightbox" data-remote="' + fields[1] + '" data-gallery="gallery" src="' + fields[1] + '"> ' + '</div> ' + '<span>' + fields[0] + '</span> ' + '</div>';Handl;
        },
        ...
        bulkDelete: function bulkDelete(route) {
            var _this2 = this;

            if (confirmModal(function ($noty) {
                $noty.$buttons.find('.btn').addClass('disabled').prop('disabled', true);
                if (_this2.selectedTo.length && _this2.selectedTo.length > 0) {
                    _this2.$http.post(route, { ids: _this2.selectedTo }).then(function (response) {
                        notify({
                            type: 'success',
                            text: response.body.data.msg
                        });
                        _this2.selectedTo = [];
                        _this2.$refs.vuetable.selectedTo = [];
        ...
        onCheckboxToggled: function onCheckboxToggled(checked, item) {
    ...
    components: {
        'detailed-totals': _DetailedTotals2.default,
...
},{"../Popover.vue":5,"../Spinner.vue":6,"../vuetable/Vuetable.vue":10,"../vuetable/VuetablePagination.vue":11,"../vuetable/VuetablePaginationInfo.vue":12,"./DetailedTotals.vue":7}],9:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    methods: {
        ...
        loadData: function loadData() {
            ...
            Vue.http.get(this.apiUrl, this.httpOptions).then(success, failed);
        },
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/jake/www/kabooodle/framework/resources/assets/app/components/vuetable/VuetablePagination.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, module.exports.template)
...
},{"./VuetablePaginationMixin.vue":14,"vue":3,"vue-hot-reload-api":2}],12:[function(require,module,exports){
'use strict';
...
var _VuetablePaginationInfoMixin = require('./VuetablePaginationInfoMixin.vue');
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n    <div :class=\"['vuetable-pagination-info', infoClass]\" v-html=\"paginationInfo\">\n    </div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/jake/www/kabooodle/framework/resources/assets/app/components/vuetable/VuetablePaginationInfo.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, module.exports.template)
...
},{"./VuetablePaginationInfoMixin.vue":13,"vue":3,"vue-hot-reload-api":2}],13:[function(require,module,exports){
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/jake/www/kabooodle/framework/resources/assets/app/components/vuetable/VuetablePaginationInfoMixin.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, module.exports.template)
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/jake/www/kabooodle/framework/resources/assets/app/components/vuetable/VuetablePaginationMixin.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, module.exports.template)
...
},{"vue":3,"vue-hot-reload-api":2}]},{},[8]);

//# sourceMappingURL=listables-detailed.js.map
